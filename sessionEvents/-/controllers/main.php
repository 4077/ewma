<?php namespace ewma\sessionEvents\controllers;
...
class Main extends \Controller
{
    ...
    {
        $bindings = &$this->s(':' . $this->eventInstance . '|' . $this->eventPath);
...
//        $this->app->sessionEvents->addInstance($this->eventInstance);
    }

    public function unbind()
    {
        $s = &$this->s(':|' . $this->eventPath);
    ...
    {
        SessionModel::where('module_namespace', $this->_module()->namespace)
